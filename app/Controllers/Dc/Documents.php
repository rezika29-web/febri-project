...
class Documents extends BaseController
{
    ...
    public function show(int $id)
    {
        ...
        $ownerApproval = $doc['approved_by'] ? $this->users->find($doc['approved_by']) : null;
    ...
    public function print(int $id)
    {
        ...
        $owner = $this->users->find($doc['owner_id']);
        $reviewer = $doc['reviewer_id'] ? $this->users->find($doc['reviewer_id']) : null;
        $approver = $doc['approved_by'] ? $this->users->find($doc['approved_by']) : null;
    ...
    public function review(int $id): RedirectResponse
    {
        ...
        $this->documents->update($id, ['status' => $docStatus, 'reviewer_id' => $currentUser['id']]);
